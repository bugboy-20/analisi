...
%$$
%    f(\ox+h) - f(\ox) \geq \vert h\vert^2 \left(\frac{1}{2}m + \frac{o\left(\vert h\vert^2\right)}{\vert h\vert^2}\right) \geq \vert h\vert^2 \left(\frac{m}{2} - \frac{m}{4}\right) = \frac{m}{4}\vert h\vert^2 \geq 0 \;\;\;\;\forall h\in B(0,\delta)
%$$
